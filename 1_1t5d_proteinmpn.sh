...
PDB=~/drylab_igem/proteinmpn_part/Proteins_pdbs/1t5d.pdb
FIXED_DIR=~/drylab_igem/proteinmpn_part/Fixed_positions/1t5d
OUT_BASE=~/drylab_igem/proteinmpn_part/Results/1t5d


conda activate proteinmpnn

# Loop over all *_binmask.json
